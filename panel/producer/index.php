...
<main class="admin-main">
    ...
    <div class="admin-content">
        ...
        <div class="pending-banner">
            Beklemede: Hesabınız henüz onay aşamasındadır. Ürünlerinizi ekleyebilirsiniz ancak onaylanana kadar yayınlanmayacaktır.
        </div>
        <?php endif; ?>
        ...
        <div class="stats-grid">
            <div class="stat-card stat-card--blue">
                ...
                <div class="stat-info"><span class="stat-value"><?php echo $totalProducts; ?></span><span class="stat-label">Aktif Ürün</span></div>
            </div>
            ...
            <div class="stat-card stat-card--green">
                ...
                <div class="stat-info"><span class="stat-value"><?php echo $totalOrders; ?></span><span class="stat-label">Toplam Sipariş</span></div>
            </div>
            <div class="stat-card stat-card--purple">
                ...
                <div class="stat-info"><span class="stat-value">₺<?php echo number_format($totalEarnings, 2, ',', '.'); ?></span><span class="stat-label">Toplam Kazanç</span></div>
            </div>
            <div class="stat-card stat-card--rose">
                ...
                <div class="stat-info"><span class="stat-value">₺<?php echo number_format($heldEarnings, 2, ',', '.'); ?></span><span class="stat-label">Bekleyen Ödeme</span></div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <?php if (empty($recentOrders)): ?>
                    <p class="text-muted text-center">Henüz sipariş yok. Ürünlerinizi ekleyerek başlayın!</p>
                <?php else: ?>
                <table class="data-table">
                    <thead><tr><th>Sipariş</th><th>Müşteri</th><th>Tutar</th><th>Kazanç</th><th>Durum</th><th>Tarih</th></tr></thead>
                    <tbody>
                        <?php foreach ($recentOrders as $o): ?>
                        <tr>
                            <td><a href="order-detail.php?id=<?php echo $o['id']; ?>" class="link"><?php echo htmlspecialchars($o['sub_order_number']); ?></a></td>
                            <td><?php echo htmlspecialchars($o['customer_name']); ?></td>
                            <td class="text-bold">₺<?php echo number_format($o['subtotal'], 2, ',', '.'); ?></td>
                            <td style="color:var(--success)">₺<?php echo number_format($o['producer_earning'], 2, ',', '.'); ?></td>
