...
$producerMenu = [
    ...
    ['page' => 'products', 'icon' => 'package',      'label' => 'ÃœrÃ¼nlerim'],
    ['page' => 'orders',   'icon' => 'shopping-cart', 'label' => 'SipariÅŸlerim'],
    ['page' => 'earnings', 'icon' => 'credit-card',  'label' => 'KazanÃ§larÄ±m'],
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div class="sidebar-user-info">
                ...
                <span class="sidebar-user-role">Ãœretici</span>
            </div>
        </div>
        <a href="logout.php" class="sidebar-logout" title="Ã‡Ä±kÄ±ÅŸ">
